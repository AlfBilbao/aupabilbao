...
<body id="page-body">
	<div class="wrapper">
					...
					<div id="menudesplegable" class="collapse navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown"><a href="#" title="" class="dropdown-toggle" data-toggle="dropdown"><span class="texto">profesional</span> <b class="caret"></b></a>
								...
								<li><a href="http://www.aupabilbao.eu/referenciaslaboralesalfredorios.php" title="Referencias Laborales Alfredo Rios"><span class="texto">referencias</span></a></li>								
								</ul>
							</li>
		...
		<section id="sec0" class="noprint">
			<div id="titulo">
				<h1 class="menuautor">Hola, me llamo <strong>Alfredo</strong> Rios</h1>
				<h2>Ongi Etorri, bienvenido, quiero compartir contigo información sobre mí.</h2>
				<h3 class="menuautor">Ya que has llegado hasta aquí, clica en las diferentes opciones, enreda un poco.</h3>	
			</div>
		...
		<section id="sec1" class="sec1">
			<h2 class="ezbegi">Información sobre Alfredo Rios</h2>
			<article class="limpia">
				...
				<p>Lo que estás viendo es una aplicación de mis conocimientos en <strong>HTML5, CSS3, Javascript, jQuery, Ajax, PHP y MySql</strong>, y tambien aplicando al máximo el <strong>SEO</strong>, el llamado "<em>posicionamiento organico</em>". Si indagas veras que he buscado  complicaciones, botones, diferentes menús, textos que desaparecen, efectos de movimiento, diferentes visores de fotos, etc.</p><br>
				...
				<p>El propósito, es mostrar una página Web utilizando las ultimas tecnologías. La Web es "responsive", Diseño Web Adaptable y preparada para todo tipo de dispositivos móviles. Esta optimizada para el navegador Google Chrome, pero funciona con todos los navegadores actuales, eso sí, actualizados.</p><br>
				...
				<p>De mientras, sigo en mi proceso de formación continua, en este mundo de desarrollo web y de marketing digital.</p><br>	
				<p>Echa un vistazo, y quien  sabe, igual nos encontramos .</p>	

			</article>
		</section>
		<section id="sec2" class="sec2">
			<h2 class="ezbegi">Presentación de Alfredo Rios</h2>		
			<article class="limpia">
				...
				<p>Creo que mis<strong> 24 años de experiencia como responsable de proyectos</strong>, pueden aportar un gran valor en las áreas de<strong> Consultoría Informática, Desarrollo de Aplicaciones Escritorio o Web, Marketing Digital u online</strong>.</p><br>
				<p>En mi trayectoria, y a pesar de las mas diversas situaciones, siempre se ha intentado no perder los objetivos, que principalmente son:</p>
				<p>- dar el mejor servicio al cliente</p>
				<p>- mantener al equipo de trabajo motivado y entregado</p>
				<p>- e intentar, en la medida de lo posible, cumplir con el plazo previsto para la entrega final del proyecto.</p><br>
				<p>Actualmente busco ampliar horizontes, busco nuevos retos profesionales, <strong>donde pueda aportar mis experiencias, y ser un valor añadido</strong>. Sería gratificante, una nueva empresa, nuevos clientes, nuevos compañeros, seguramente nuevas tecnologías, muy ilusionante todo ello.</p>
				<p>Me niego a creer que toda una trayectoria se resuma en la frasecita "<em>lo siento, tienes demasiados años</em>". Parece que sobramos los mayores de 45..., lo dicho, me niego a creerlo. <strong>Sigo teniendo la misma iniciativa, capacidad de entrega, y ganas de compartir y de aprender</strong>.</p>
				<p>Aquí un dato:</p>
				<blockquote>El 75% de las empresas no aprecia el capital humano que aportan los trabajadores mayores de 45 años.</blockquote>
				<p>Pues al 25% restante me dirijo. Creo firmemente que puedo <strong>contribuir, cooperar, enseñar, e insisto aprender</strong>.</p><br>
		...
		<section id="sec3" class="sec3">
			<h2 class="ezbegi">Experiencia Laboral de Alfredo Rios, una primera introducción</h2>		
			<article class="limpia">
				<a id="recomendacion" class="botonsec label label-info noprint" href="http://www.aupabilbao.eu/referenciaslaboralesalfredorios.php" title="Referencias Laborales Alfredo Rios">ver Referencias</a>
				<h3 class="ezbegi">Curriculum Alfredo Rios Gomez de AupaBilbao en Bilbao, Experiencia, Introducción</h3>
			...
			<h2 class="ezbegi">Experiencia Laboral de Alfredo Rios, relación de todas las empresas.</h2>
			<article>
				<h3 class="ezbegi">Curriculum Alfredo Rios Gomez de AupaBilbao en Bilbao, Experiencia, Lista de Empresas</h3>
				<h4 class="ezbegi">Desarrollo</h4>
				<ul class="row">
					<li class="col-md-3 col-sm-4 cols-xs-12 text-right"><strong>Noviembre 2014 <span>Diciembre 2014</span></strong></li>
					<li class="col-md-9 col-sm-8 cols-xs-12 text-left"><strong>Programador MySQL</strong> <span><i>1 mes</i></span></li>
					<li class="col-md-3 col-sm-4 cols-xs-12 text-right"><small>Empresa:</small></li>
					<li class="col-md-9 col-sm-8 cols-xs-12 text-left">Aqmetrix S.L.U.</li>
					<li class="col-md-3 col-sm-4 cols-xs-12 text-right"><small>Función:</small></li>
					<li class="col-md-9 col-sm-8 cols-xs-12 text-justify">Desarrollo de una base de datos en MySQL. Programar procedimientos almacenados.</li>
				</ul>
				<p>&nbsp;</p>				
				<ul class="row">
		...
		<section id="sec4" class="sec4">
			<h2 class="ezbegi">Formación, cursos y aptitudes, realizados por Alfredo Rios, durante su trayectoria profesional</h2>
			<article class="limpia">
				...
				<ul class="row">
					...
					<li class="col-md-6 col-sm-5 cols-xs-12 text-left">510h - Consultec S.L., Bilbao, Certificado de Profesionalidad Nivel 3 IFCD0210</li>
				</ul>				
				<ul class="row">
				...
				<ul class="row">
					<li class="col-md-6 col-sm-7 cols-xs-12 text-left"><strong>2015<span>SEO, SEM y estrategias de marketing online</span></strong></li>
					<li class="col-md-6 col-sm-5 cols-xs-12 text-left">&nbsp;30h - Consultec S.L., Bilbao</li>
				</ul>	
				<ul class="row">
					<li class="col-md-6 col-sm-7 cols-xs-12 text-left"><strong>2015<span>Marketing Digital</span></strong></li>
					<li class="col-md-6 col-sm-5 cols-xs-12 text-left">&nbsp;40h - IAB Spain</li>
				</ul>				
				<ul class="row">
					<li class="col-md-6 col-sm-7 cols-xs-12 text-left"><strong>2014<span>Programación para Dispositivos Móviles Android y Java</span></strong></li>
					<li class="col-md-6 col-sm-5 cols-xs-12 text-left">112h - Almi Bilbao S.A., Bilbao</li>
				</ul>
				<ul class="row">
				...
				<ul class="row">
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>HTML5, CSS3, Javascript, jQuery, Ajax y Php</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Microsoft SQL Server, MySQL</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>SEO, SEM, Web 2.0</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Google Webmaster Tools, Google Analytics, Google AdWords‎</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Visual Basic (VB)</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Visual Basic NET (VB.NET)</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Microsoft Office</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Microsoft Windows Server 2000/2003</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Microsoft Windows XP/2000/Vista/7/8</strong></li>
				</ul>
				<p>&nbsp;</p>
				<ul class="row">
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Dirección de equipos</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Administración de Usuarios y Accesos</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Desarrollo y Parametrización ERP</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Planificación de Proyectos ERP</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Software de Contabilidad</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Software de Facturación</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Gestión Documental</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Control de Stocks</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Control de Incidencias</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Mantenimiento Preventivo, Correctivo y Predictivo</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Recepción de Facturas</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Recepción de Materias Primas</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Expedición de Productos Terminados</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Producción</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Controles de Calidad</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Gestión Presupuestaria</strong></li>
					<li class="text-success cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Gestión de Clientes</strong></li>
					<li class="cols-xs-12">&nbsp;&nbsp;&nbsp;<strong>Gestión de Proveedores</strong></li>					
				</ul>		
				
			</article>
		</section>
		<section id="sec5" class="sec5">
			<h2 class="ezbegi">Como contactar con Alfredo Rios, asi como links a InfoJobs, Linkedin, beBee, Instagram, Twitter, Youtube, Facebook y Google+</h2>		
			<article class="limpia">
				...
				<div class="icosocial noprint">
					<ul>
						<li><a href="https://www.bebee.com/bee/alfredoriosgomez" target="_blank" title="Nueva ventana bebee.com">
						<img class="" src="imagenes/bebee48x48.png" alt="beBee">				
						</a></li>
						<li>&nbsp;</li>					
						<li><a href="http://www.infojobs.net/alfredo-rios.prf" target="_blank" title="Nueva ventana infojobs.net">
						<img class="" src="imagenes/infojobs48x48.png" alt="InfoJobs">				
						</a></li>
						<li>&nbsp;</li>					
						...
						<li><a href="https://youtu.be/hgBGcVt8CH0" target="_blank" title="Nueva ventana aupabilbao youtube.com">
		...
		<section id="sec6" class="sec6">
			<h2 class="ezbegi">Aficiones de Alfredo Rios, su pasión por los viajes y las fotografías</h2>
			<article class="limpia">
				...
				<h5 class="text-right lead"><strong><cite>Una vez al año ve a algún lugar en el que nunca hayas estado antes.</cite></strong></h5><h6 class="text-right"><strong><i> Dalai Lama</i></strong></h6>
				<h5 class="text-left lead"><strong><cite>Un buen viajero no tiene planes fijos ni la intención de llegar.</cite></strong></h5><h6 class="text-left"><strong><i> Lao Tse</i></strong></h6>
				<h5 class="text-right lead"><strong><cite>El único verdadero viaje de descubrimiento consiste no en buscar nuevos paisajes, sino en mirar con nuevos ojos.</cite></strong></h5><h6 class="text-right"><strong><i> Marcel Proust</i></strong></h6>
				<h5 class="text-left lead"><strong><cite>Nuestro destino de viaje nunca es un lugar, sino una nueva forma de ver las cosas.</cite></strong></h5><h6 class="text-left"><strong><i> Henry Miller</i></strong></h6>
				<h5 class="text-right lead"><strong><cite>Viajar enseña tolerancia.</cite></strong></h5><h6 class="text-right"><strong><i> Benjamin Disraeli</i></strong></h6>				
				<h5 class="text-left lead"><strong><cite>Vive como si fueras a morir mañana. Aprende como si fueras a vivir para siempre.</cite></strong></h5><h6 class="text-left"><strong><i> Mahatma Gandhi</i></strong></h6>
				<h5 class="text-right lead"><strong><cite>El que no sale nunca de su tierra está lleno de prejuicios.</cite></strong></h5><h6 class="text-right"><strong><i> Carlo Goldoni</i></strong></h6>								
				<h5 class="text-left lead"><strong><cite>Aquel que quiere viajar feliz, debe viajar ligero.</cite></strong></h5><h6 class="text-left"><strong><i> Antoine de Saint-Exupery</i></strong></h6>
				<h5 class="text-right lead"><strong><cite>El mundo es un libro, y quienes no viajan leen sólo una página.</cite></strong></h5><h6 class="text-right"><strong><i> San Agustín de Hipona</i></strong></h6>							
				<h5 class="text-left lead"><strong><cite>He descubierto que no hay forma más segura de saber si amas u odias a alguien que hacer un viaje con él.</cite></strong></h5><h6 class="text-left"><strong><i> Mark Twain </i></strong></h6>				
			</article>
		</section>
		<section id="sec7" class="sec7 noprint">
			<h2 class="ezbegi">Pie del curriculum de Alfredo Rios, donde se refleja las tecnologías empleadas</h2>
			<article class="limpia">
